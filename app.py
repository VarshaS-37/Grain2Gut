...
def home():
    ...
    st.markdown("<h3 style='text-align:center;'><i>Linking genomic potential of Millet derived Lactic Acid Bacteria to food and probiotic applications</i></h3>", unsafe_allow_html=True)
    st.write("") 
