...
def summary():
    ...
    st.markdown("<h5 style='text-align:left;'>1. Which are the top abundant EC numbers and what do they imply? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>2. Which are the dominant EC classes and what do they mean? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>3. Which are the dominant BRITE classes and subclasses of the pathways associated with each EC number and what do they mean? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>4. Overall, are the predicted ECs supporting the use of these LAB in probiotic/food applications? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h4 style='text-align:left;'>KO Analysis Summary</h4>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align:left;'>1. Which are the top abundant KO ids and what do they imply? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>2. Which are the dominant BRITE classes and subclasses of the pathways associated with each KO id and what do they mean? </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>3. Overall, are the predicted KOs supporting the use of these LAB in probiotic/food applications?</h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h4 style='text-align:left;'>PWY Analysis Summary</h4>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align:left;'>1. Which are the pathways which have completeness as 1 and what do they imply?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>2. Which pathways are enriched in a LAB than the other LABs?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>3. Overall, how relevant are the predicted pathways in terms of probiotic/food appplications?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h4 style='text-align:left;'>Biological Traits Analysis Summary</h4>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align:left;'>1. Which are the dominant biological traits and whay do they mean?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>2. Which are the common biological traits and whay do they mean?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>3. Which are the unique biological traits and whay do they mean?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>4. Which are the biological traits contributed by ECs?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>5. Which are the biological traits contributed by KOs?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>6. Which are the biological traits contributed by PWYs?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
    st.markdown("<h5 style='text-align:left;'>7. Overall, what are the biological traits supporting the use of these LABs in probiotic/food applications?  </h5>", unsafe_allow_html=True)
    st.markdown("""Answer""")
